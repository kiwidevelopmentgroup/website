...
var nab_html = `
    <div class="nab_wrapper">
        <div class="nab_card">
            <span class="nab_title">⚠️Please Disable Your Adblock</span>
            <span class="nab_desc">Please disable your Adblocker to access this website.
            Make sure your browser does not block ads. If you see this message again, use a different browser.</span>
        </div>
    </div>
`;
