...
var nab_html = `
    <div class="nab_wrapper">
        <div class="nab_card">
            ...
            <span class="nab_desc">This website is supported by ads. Please disable your Ad-Block and refresh the page to continue.</span>
        </div>
    </div>
`;
...
function testAdBlock() {
    ...
    testEl.className = 'ad'; // Changed class name to 'ad'
...
document.addEventListener('DOMContentLoaded', testAdBlock);
